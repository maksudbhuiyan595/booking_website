...
@section('schema')
    @php
        $taxiSchema = [
            ...
            "url" => url()->current() . '/',
            "image" => asset('images/Boston Logaqn Aorport Taxi Service.webp'),
        ...
        <div class="row align-items-center mb-5">
            <div class="col-lg-7">
                ...
                <p class="text-content">
                    ...
                    <a href="#" class="highlight-link">Boston Logan Airport taxi service</a> that prioritizes comfort and
                    punctuality.
                </p>
            </div>
