                ...
                <div class="reservation-card" id="floatingCard">
                    ...
                    <form id="reservationForm" action="{{ route('step2') }}" method="GET" novalidate>
                        ...
                        <div class="row g-1 mb-1">
                            <div class="col-6">
                                <div class="input-group"><input type="text" placeholder="mm/dd/yyyy"
                                        onfocus="(this.type='date')"
                                        onblur="(this.value ? this.type='date' : this.type='text')" id="date"
                                        name="date" class="form-control" required></div>
                            </div>
                            <div class="col-6">
                                <div class="input-group"><select id="time" name="time" class="form-select"
                                        required>
                        ...
                        <div class="trip-type-container">
                            <div class="trip-option"><input type="radio" name="tripType" id="type_from"
                                    value="fromAirport" checked><label class="trip-card" for="type_from"><i
                                        class="fas fa-plane-arrival"></i><span>From Airport</span></label></div>
                            <div class="trip-option"><input type="radio" name="tripType" id="type_to"
                                    value="toAirport"><label class="trip-card" for="type_to"><i
                                        class="fas fa-plane-departure"></i><span>To Airport</span></label></div>
                            <div class="trip-option"><input type="radio" name="tripType" id="type_ptp"
                                    value="doorToDoor"><label class="trip-card" for="type_ptp"><i
                                        class="fas fa-map-marker-alt"></i><span>Door-to-Door</span></label></div>
                        </div>
                        ...
                        <div class="row g-1 mt-1">
                            <div class="col-6"><span class="mini-label">Adults (8+)</span>
                                <div class="input-group"><span class="input-group-text"><i
                                            class="fas fa-users"></i></span><select name="adults" class="form-select"
                                        required>
                            ...
                            <div class="col-6"><span class="mini-label">Children (<7)< /span>
                                        <div class="input-group"><span class="input-group-text"><i
                                                    class="fas fa-child"></i></span><select name="children"
                                                class="form-select">
                                                <option value="">Select</option>
                                                @for ($i = 1; $i <= 4; $i++)
                                                    <option value="{{ $i }}">{{ $i }}</option>
                        ...
                        <div class="row g-1 mt-1">
                            <div class="col-6"><span class="mini-label">Luggage</span>
                                <div class="input-group"><span class="input-group-text"><i
                                            class="fas fa-suitcase"></i></span><select name="luggage"
                            ...
                            <div class="col-6"><span class="mini-label">Child Seats</span>
                                <div class="input-group"><span class="input-group-text"><i
                                            class="fas fa-chair"></i></span><select name="seats_dummy"
                                        id="childSeatsTrigger" class="form-select">
                        ...
                        <div class="mt-2">
                            <div class="extras-toggle" id="toggleExtrasBtn"><i class="fas fa-plus-circle"></i> Add
                                Stops & Specific Seats</div>
                            <div id="extrasSection">
                                <div class="extra-row">
                                    <div class="extra-info">
                                        <div class="extra-label">Stopover/Pets <span
                                                class="extra-price-tag">$10</span></div>
                                    </div>
                                    <div class="d-flex align-items-center"><select id="stopover" name="stopover"
                                            data-price="10" class="extra-select-box">
                                ...
                                <div class="extra-row">
                                    <div class="extra-info">
                                        <div class="extra-label">Infant Seat <span class="extra-price-tag">$10</span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center"><select id="infantSeat" name="infant_seat"
                                            data-price="10" class="extra-select-box">
                                            <option value="0">0</option>
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                ...
                                <div class="extra-row">
                                    <div class="extra-info">
                                        <div class="extra-label">Front Facing <span class="extra-price-tag">$10</span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center"><select id="frontSeat" name="front_seat"
                                            data-price="10" class="extra-select-box">
                                            <option value="0">0</option>
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                ...
                                <div class="extra-row">
                                    <div class="extra-info">
                                        <div class="extra-label">Booster Seat <span class="extra-price-tag">$5</span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center"><select id="boosterSeat"
                                            name="booster_seat" data-price="5" class="extra-select-box">
                                            <option value="0">0</option>
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                        </select>
                            ...
                            <p class="footer-note">Pay only $1 to confirm. Balance payable after service. 10% cash
                                discount.</p>
                        </div>
                    </form>
                </div>
            ...
            <div class="col-lg-7">
                <div class="description-column">
                    <p class="description-text">
                        ...
                        Distance Car Services from/to Boston, Door to Door transfers and Chauffeured Cars for special
                        occasions.
                    </p>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB8jlhc5ZRDUU1SHHpxuwFh4dM0Ggq4n2Q&libraries=places">
</script>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        function buildAirportSelect(name) {
            let html =
                `<select name="${name}" class="form-select" required><option value="">Select Airport</option>`;
            airports.forEach(airport => {
                html +=
                    `<option value="${airport.id}" data-address="${airport.address}">${airport.name}</option>`;
            });
            html += `</select>`;
            return html;
        }
        ...
        function updateTrip() {
            ...
            if (t === 'fromAirport') {
                ...
                toLoc.innerHTML =
                    `<input type="text" name="to_address" id="toAddress" class="form-control" placeholder="Drop Off Address" required>`;
                ...
                fromLoc.innerHTML =
                    `<input type="text" name="from_address" id="fromAddress" class="form-control" placeholder="Pick Up Address" required>`;
        ...
        loadAirports(() => {
            ...
            document.querySelectorAll('input[name="tripType"]').forEach(r => r.addEventListener(
                'change', updateTrip));
        });
        ...
        form.addEventListener("submit", function(e) {
            ...
            const fromVal = document.querySelector('[name="from_airport"]')?.value || document
                .querySelector('[name="from_address"]')?.value;
            const toVal = document.querySelector('[name="to_airport"]')?.value || document
                .querySelector('[name="to_address"]')?.value;
